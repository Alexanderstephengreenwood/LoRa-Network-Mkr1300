...
- DevAddr: Device Address: 32-bit identifier stored in the end-device. Uniquely identifies the device on the network. Obtained during the Activation proces.
...
- AppKey: Application Key –master Key Used to derive NwkSKey and AppSKey
...
- AppEUI: Identifies the JoinServer component
